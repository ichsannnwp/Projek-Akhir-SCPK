    ...
    if "df_rawlaptop" in st.session_state and "df_fixlaptopcpu" in st.session_state and "df_fixlaptopgpu" in st.session_state:
        ...
        if not df_ranking.empty:
            ...
            st.info(
                ...
                f"dengan Skor Kelayakan **{laptop_juara['Skor_Kelayakan']:.2f}/100**."
            )
            st.dataframe(df_ranking[["Model", "multiScore", "3DMark", "RAM_GB", "Storage_GB", "Price_USD", "Skor_Kelayakan"]], width='stretch')
